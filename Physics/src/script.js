...
// if an object is not moving it will not check if it is colliding
...
const createBox = (width, height, depth, position) => {
    ...
    const body = new CANNON.Body({
        mass:1,
        position: new CANNON.Vec3(1, 0.5, 1),
        shape: shape,
        material: defaultMaterial
...
const tick = () =>
{
    ...
    // 3 parameters
    // A fixed Time step, 
    // how much time passes since the last step
